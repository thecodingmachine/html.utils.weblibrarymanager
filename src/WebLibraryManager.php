...
class WebLibraryManager implements HtmlElementInterface
{
     ...
     * @param WebLibraryInterface[] $webLibraries
     */
    public function __construct(RendererInterface $renderer, array $webLibraries = [])
    {
        $this->renderer = $renderer;
        $this->setWebLibraries($webLibraries);
    }
     ...
     */
    public function addLibrary(WebLibraryInterface $library): void
    {
        if ($this->rendered) {
     ...
     *
     * @param WebLibraryInterface[] $libraries
     */
    public function setWebLibraries(array $libraries): void
    {
     ...
     */
    public function addAdditionalScript($additionalScript): void
    {
